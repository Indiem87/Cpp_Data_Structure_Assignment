...
class LinkList{
    ...
    public:
        ...
        LinkList<T>* unionWithAnotherSortedList(LinkList<T>* L){
            int total_length = length + L->length;
            T* a = new T[total_length];
            int i = 0,b1 = 0,b2 = 0;
            DNode<T>* tmpNode1 = head->next;
            DNode<T>* tmpNode2 = L->head->next;
            ...
            LinkList<T>* NL = new LinkList<T>(a,total_length);
            return NL;
        }
};
/* UPLOAD END */
